            ...
            <div className="space-y-8 col-span-2 flex flex-col items-center lg:items-start">
              <NavLink to={"/"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                <img
                  ...
                  alt="OMS Logo"
                  className="w-32 sm:w-36 lg:w-40 h-auto cursor-pointer"
                />
              </NavLink>
              ...
              <div className="flex items-center gap-3 flex-wrap justify-center sm:justify-start">
                {socials.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 sm:w-9 sm:h-9  // Slightly larger on mobile flex items-center justify-center
                  rounded-full bg-gray-50 text-[#1A202C] shadow-[2px_6px_10px_rgba(0,0,0,0.15)] transition-all duration-300 cursor-pointer hover:scale-105 hover:bg-white hover:shadow-[2px_6px_10px_rgba(84,62,210,0.5)] active:scale-95 // Add press effect on mobile"
                  >
                    <img
                      src={social.src}
                      alt={social.alt}
