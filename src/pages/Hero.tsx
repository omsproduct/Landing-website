                ...
                <div className="relative z-10 flex flex-col items-center mt-26 min-h-screen">
                    ...
                    <div className="flex items-end gap-6 max-w-6xl mt-10 mx-auto ">
                        ...
                        <div className="relative w-52 h-80">
                            ...
                            <div className="absolute top-7 -left-6 w-48 h-140 bg-white rounded-tl-4xl rounded-tr-4xl overflow-hidden border border-gray-100 shadow-[0_0_20px_5px_rgba(84,62,210,0.3)]">
                                <img
                            ...
                            {/* Top Image - Campus */}
                            <div className="absolute top-0 -right-7 w-48 h-180 bg-white  rounded-tl-4xl rounded-tr-4xl  overflow-hidden border border-gray-100 shadow-[0_0_20px_5px_rgba(84,62,210,0.3)]">
                                <img
                        ...
                        {/* Center Main Image */}
                        <div className="relative z-50 w-155 h-100 top-5 bg-transparent rounded-tl-4xl rounded-tr-4xl overflow-hidden border border-gray-100 shadow-[0_0_20px_5px_rgba(84,62,210,0.3)]">
                            <img
                        ...
                        <div className="relative w-52 h-80">
                            ...
                            <div className="absolute top-7 -right-6 w-48 h-110 bg-white  rounded-tl-4xl rounded-tr-4xl  overflow-hidden border border-gray-100 shadow-[0_0_20px_5px_rgba(84,62,210,0.3)]">
                                <img
                            ...
                            {/* tom Image - Salary */}
                            <div className="absolute -bottom-30 right-11 w-48 h-110 bg-white rounded-tl-4xl rounded-tr-4xl  overflow-hidden border border-gray-100 shadow-[0_0_20px_5px_rgba(84,62,210,0.3)]">
                                <img
